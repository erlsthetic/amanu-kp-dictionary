                  ...
                  Align(
                    ...
                    child: Row(
                      children: [
                        SizedBox(
                          ...
                          child: Obx(
                            () => DropdownButtonFormField(
                              focusNode: controller.typeFieldFocusNode[i],
                              validator: (value) {
                                if (value != null) {
                        ...
                        GestureDetector(
                          onTap: () async {
                            await controller.addTypeField(i + 1);
                            controller.typeFields.refresh();
                            controller.definitionsFields.refresh();
                            controller.typeFieldFocusNode[i + 1].requestFocus();
                            Scrollable.ensureVisible(
                                controller.typeFieldFocusNode[i].context!,
                            ...
                            child: Container(
                              child: Column(children: [
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: TextFormField(
                                          focusNode: controller
                                              .definitionFieldFocusNode[i][j],
                                          validator: (value) {
                                            if (value != null) {
                                              return controller
                                                  .validateDefinition(value);
                                            } else {
                                              return "Please enter a valid definition.";
                                            }
                                          },
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          controller.addDefinitionField(
                                              i, j + 1);
                                          controller.typeFields.refresh();
                                          controller.definitionsFields
                                              .refresh();
                                          controller.definitionFieldFocusNode[i]
                                                  [j + 1]
                                              .requestFocus();
                                        },
                                        child: Container(
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    controller: controller.definitionsFields[i]
                                        [j][1],
                                    minLines: 1,
                                    maxLines: 4,
                                    decoration: InputDecoration(
